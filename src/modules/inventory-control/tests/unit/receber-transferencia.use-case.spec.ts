...
describe('ReceberTransferenciaUseCase', () => {
  ...
  describe('Validações', () => {
    it('deve lançar erro quando a transferência não é encontrada', async () => {
    ...
    it('deve lançar erro quando a transferência tem status CRIADA', async () => {
    ...
    it('deve lançar erro quando a transferência já foi recebida', async () => {
  ...
  describe('Atualização de status', () => {
    it('deve atualizar o status da transferência para RECEBIDA', async () => {
      const transferencia = makeTransferencia();
      const itens = makeItens();
